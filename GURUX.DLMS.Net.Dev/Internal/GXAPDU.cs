    ...
    class GXAPDU
    {
        ...
        private static void GetAuthenticationString(GXDLMSSettings settings, GXByteBuffer data, bool ignoreAcse)
        {
               ...
               )
            {
                ...
                data.SetUInt8(7);
                // OBJECT IDENTIFIER
                byte[] p = { 0x60, 0x85, 0x74, 0x05, 0x08, 0x02, (byte)settings.Authentication };
                data.Set(p);
            }
        ...
        internal static void GenerateUserInformation(GXDLMSSettings settings, GXICipher cipher, GXByteBuffer encryptedData, GXByteBuffer data)
        {
        ...
        /// Generates Aarq.
        ///</summary>
        internal static void GenerateAarq(GXDLMSSettings settings, GXICipher cipher, GXByteBuffer encryptedData, GXByteBuffer data)
        {
            //AARQ APDU Tag
                ...
                if (xml != null)
                {
                    ...
                    if (xml.OutputType == TranslatorOutputType.StandardXml)
                    {
                        ...
                        String value = TranslatorStandardTags
                                .GetServiceErrorValue(type, data.GetUInt8());
        ...
        ///Parse APDU.
        ///</summary>
        internal static object ParsePDU(GXDLMSSettings settings, GXICipher cipher,
        ...
        internal static object ParsePDU2(GXDLMSSettings settings, GXICipher cipher,
                GXByteBuffer buff, GXDLMSTranslatorStructure xml)
        {
            int len;
            byte tag;
