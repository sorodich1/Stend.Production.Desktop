...
namespace Gurux.DLMS.ASN
{
    internal sealed class GXAsn1Settings
    {
        ...
        internal GXAsn1Settings()
        {
            ...
            AddTag(((short)BerType.Constructed | (short)BerType.Context | 1), "Constructed-Context-Specific-1");
            AddTag(((short)BerType.Constructed | (short)BerType.Context | 2), "Constructed-Context-Specific-2");
            AddTag(((short)BerType.Constructed | (short)BerType.Context | 3), "Constructed-Context-Specific-3");
