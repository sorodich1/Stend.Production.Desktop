...
namespace Gurux.DLMS
{
...
#if ZIP
                types.Add(typeof(GXDLMSEmergencyProfile));
                types.Add(typeof(GXDLMSScript));
                types.Add(typeof(GXDLMSScriptAction));
                types.Add(typeof(GXDLMSObjectDefinition));
                types.Add(typeof(GXDLMSSeasonProfile));
                types.Add(typeof(GXDLMSWeekProfile));
                types.Add(typeof(GXDLMSDayProfile));
                types.Add(typeof(GXDLMSDayProfileAction));
                types.Add(typeof(GXDLMSActionItem));
                types.Add(typeof(GXDLMSSpecialDay));
                types.Add(typeof(GXDLMSImageActivateInfo));
                types.Add(typeof(GXDLMSCaptureObject));
        ...
        internal static string GetDescription(ErrorCode error)
        {
            ...
            switch (error)
            {
                ...
                case ErrorCode.OtherReason: // Access Error : Other Reason.
                    ...
                    break;
#if ZIP
                case ErrorCode.UserAbortMode: // User abort operatin.
                    str = Gurux.DLMS.Properties.Resources.UserAbortModeTxt;
                    break;
#endif
                default:
     ...
     */
        ...
        internal static void GetActionInfo(ObjectType objectType, out int value, out int count)
        {
            count = value = 0;
            switch (objectType)
            {
