...
namespace Gurux.DLMS.Secure
{
    ...
    class GXDLMSChipperingStream
    {
        ...
        {
            return SBox[value & 0xFF] | (((uint)SBox[(value >> 8) & 0xFF]) << 8) |
        ...
        void EncryptBlock(uint[,] key)
        {
            ...
            C0 = SBox[r0 & 0xFF] ^ (((uint)SBox[(r1 >> 8) & 0xFF]) << 8) ^ (((uint)SBox[(r2 >> 16) & 0xFF]) << 16) ^ (((uint)SBox[r3 >> 24]) << 24) ^ key[r, 0];
            C1 = SBox[r1 & 0xFF] ^ (((uint)SBox[(r2 >> 8) & 0xFF]) << 8) ^ (((uint)SBox[(r3 >> 16) & 0xFF]) << 16) ^ (((uint)SBox[r0 >> 24]) << 24) ^ key[r, 1];
            C2 = SBox[r2 & 0xFF] ^ (((uint)SBox[(r3 >> 8) & 0xFF]) << 8) ^ (((uint)SBox[(r0 >> 16) & 0xFF]) << 16) ^ (((uint)SBox[r1 >> 24]) << 24) ^ key[r, 2];
            C3 = SBox[r3 & 0xFF] ^ (((uint)SBox[(r0 >> 8) & 0xFF]) << 8) ^ (((uint)SBox[(r1 >> 16) & 0xFF]) << 16) ^ (((uint)SBox[r2 >> 24]) << 24) ^ key[r, 3];
        }
        ...
        private void DecryptBlock(uint[,] key)
        {
            ...
            r = 0;
            this.C0 = SBoxInverse[r0 & 255] ^ (((uint)SBoxInverse[(r3 >> 8) & 255]) << 8) ^ (((uint)SBoxInverse[(r2 >> 16) & 255]) << 16) ^ (((uint)SBoxInverse[(r1 >> 24) & 255]) << 24) ^ key[r, 0];
            this.C1 = SBoxInverse[r1 & 255] ^ (((uint)SBoxInverse[(r0 >> 8) & 255]) << 8) ^ (((uint)SBoxInverse[(r3 >> 16) & 255]) << 16) ^ (((uint)SBoxInverse[(r2 >> 24) & 255]) << 24) ^ key[r, 1];
            this.C2 = SBoxInverse[r2 & 255] ^ (((uint)SBoxInverse[(r1 >> 8) & 255]) << 8) ^ (((uint)SBoxInverse[(r0 >> 16) & 255]) << 16) ^ (((uint)SBoxInverse[(r3 >> 24) & 255]) << 24) ^ key[r, 2];
            this.C3 = SBoxInverse[r3 & 255] ^ (((uint)SBoxInverse[(r2 >> 8) & 255]) << 8) ^ (((uint)SBoxInverse[(r1 >> 16) & 255]) << 16) ^ (((uint)SBoxInverse[(r0 >> 24) & 255]) << 24) ^ key[r, 3];
        }
