...
namespace Gurux.DLMS
{
    ...
    public class GXDLMSMeterBase
    {
...
#if ZIP
        /// <summary>
        /// If meter UI is configured to view local meter time set this to true.
        /// this property used to override default ToString() method of the GXDateTime class
        /// </summary>
        [DefaultValue(true)]
        [JsonIgnore]
        public bool UseLocalMeterTime
        {
            get;
            set;
        }
        ...
        /// <summary>
        /// If meter UI is configured to view meter clock (time) status set this to true.
        /// this property used to override default ToString() method of the GXDateTime class
        /// </summary>
        [DefaultValue(false)]
        [JsonIgnore]
        public bool UseTimeStatusInfo
        {
            get;
            set;
        }
...
#if ZIP
                target.AuthenticationName = source.AuthenticationName;
#endif
