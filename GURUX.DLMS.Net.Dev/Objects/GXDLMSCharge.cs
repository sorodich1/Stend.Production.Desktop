...
namespace Gurux.DLMS.Objects
{
    ...
    public class GXDLMSCharge : GXDLMSObject, IGXDLMSBase
    {
        ...
        // sem 14.01.2022
        [XmlIgnore()]
        [JsonProperty("UnitChargeActivationTime")]
        public string HexStrTime
        {
            get { return UnitChargeActivationTime?.ToHex(false, false); }
            set { UnitChargeActivationTime = GXDateTime.ParseHex(value); }
        }
#else
        [XmlIgnore()]
        public GXDateTime UnitChargeActivationTime
        ...
        public string HexStrLastTime
        {
            get { return LastCollectionTime?.ToHex(false, false); }
            set { LastCollectionTime = GXDateTime.ParseHex(value); }
        }
#else
        [XmlIgnore()]
        public GXDateTime LastCollectionTime
