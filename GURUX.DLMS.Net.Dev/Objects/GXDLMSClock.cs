...
namespace Gurux.DLMS.Objects
{
    ...
    public class GXDLMSClock : GXDLMSObject, IGXDLMSBase
    {
        ...
        [XmlIgnore()]
        [JsonProperty("Time")]
        public string TimeHexStr
        {
            get
            {
                return Time?.ToHex(false, false);
            }
            set
            {
                Time = GXDateTime.ParseHex(value);
            }
        }
        ...
        [XmlIgnore()]
        [JsonProperty("Begin")]
        public string BeginHexStr
        {
            get { return Begin?.ToHex(false, false); }
            set
            {
                Begin = GXDateTime.ParseHex(value);
            }
        }
        ...
        [XmlIgnore()]
        [JsonProperty("End")]
        public string EndHexStr
        {
            get { return End?.ToHex(false, false); }
            set { End = GXDateTime.ParseHex(value); }
        }
#else
        /// <summary>
        /// Time of COSEM Clock object.
