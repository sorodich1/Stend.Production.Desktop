...
namespace Gurux.DLMS.Objects
{
    ...
    public class GXDLMSDemandRegister : GXDLMSObject, IGXDLMSBase
    {
        ...
        {
            get { return CaptureTime?.ToHex(false, false); }
            set { CaptureTime = GXDateTime.ParseHex(value); }
        }
        ...
        // sem 14.01.2022
        [XmlIgnore()]
        [JsonProperty("StartTimeCurrent")]
        public string HexStrStart
        {
            get { return StartTimeCurrent?.ToHex(false, false); }
            set { StartTimeCurrent = GXDateTime.ParseHex(value); }
        }
#else
        /// <summary>
        /// Capture time of COSEM Register object.
