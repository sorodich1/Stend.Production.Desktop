...
namespace Gurux.DLMS.Objects
{
    ...
    public class GXDLMSAccount : GXDLMSObject, IGXDLMSBase
    {
        ...
        public string HexStrActivation
        {
            get { return AccountActivationTime?.ToHex(false, false); }
            set { AccountActivationTime = GXDateTime.ParseHex(value); }
        }
#else
        [XmlIgnore()]
        public GXDateTime AccountActivationTime
        ...
        // sem 14.01.2022
        [XmlIgnore()]
        [JsonProperty("AccountClosureTime")]
        public string HexStrClosure
        {
            get { return AccountClosureTime?.ToHex(false, false); }
            set { AccountClosureTime = GXDateTime.ParseHex(value); }
        }
#else
        [XmlIgnore()]
        // sem 14.01.2022
