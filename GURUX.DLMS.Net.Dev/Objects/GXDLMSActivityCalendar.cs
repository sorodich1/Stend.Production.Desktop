...
namespace Gurux.DLMS.Objects
{
    ...
    public class GXDLMSActivityCalendar : GXDLMSObject, IGXDLMSBase
    {
        ...
        [XmlIgnore()]
#if ZIP
        [JsonConverter(typeof(DLMSSeasonProfileConverter))]
#endif
...
#if ZIP
        [JsonConverter(typeof(DLMSWeekProfileConverter))]
#endif
...
#if ZIP
        [JsonConverter(typeof(DLMSDayProfileArrayConverter))]
#endif
        [System.Xml.Serialization.XmlIgnore()]
        ...
        {
            get { return Time?.ToHex(false, false); }
            set { Time = GXDateTime.ParseHex(value); }
        }
#else
        [XmlIgnore()]
        public GXDateTime Time
        ...
        void IGXDLMSBase.SetValue(GXDLMSSettings settings, ValueEventArgs e)
        {
            ...
            else if (e.Index == 10)
            {
                ...
                {
                    //HexStrTime = ((GXDateTime)e.Value).DLMSValue;
