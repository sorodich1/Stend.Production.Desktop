...
namespace Gurux.Terminal
{
    ...
    public class GXTerminal : IGXMedia2, IGXVirtualMedia, INotifyPropertyChanged, IDisposable
    {
        ...
        /* Необъединенное слияние из проекта "Gurux.Terminal (netcoreapp3.1)"
        До:
                readonly static Dictionary<string, List<int>> BaudRates = new Dictionary<string, List<int>>();
        После:
                static readonly Dictionary<string, List<int>> BaudRates = new Dictionary<string, List<int>>();
        */

        /* Необъединенное слияние из проекта "Gurux.Terminal (netstandard2.1)"
        До:
                readonly static Dictionary<string, List<int>> BaudRates = new Dictionary<string, List<int>>();
        После:
                static readonly Dictionary<string, List<int>> BaudRates = new Dictionary<string, List<int>>();
